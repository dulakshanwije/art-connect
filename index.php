...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Art Connect">
    <meta name="keywords" content="art, galley, art connect">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/banner.jpg">
                        <div class="hero__text">
                            <span>Welcome to ArtConnect</span>
                            <h2>Where Your Art Finds a Home</h2>
                            <p>
                                <span>Explore, Create, Connect</span>
                            </p>
                ...
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-1.jpg">
                            <h5><a href="#">Wall Arts</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-2.jpg">
                            <h5><a href="#">Drawing Books</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-3.jpg">
                            <h5><a href="#">Canvas</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-4.jpg">
                            <h5><a href="#">Paints</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-5.jpg">
                            <h5><a href="#">Mediums</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-6.jpg">
                            <h5><a href="#">Brushes</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
    ...
    <section class="featured spad">
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".Colours">Colours</li>
                            <li data-filter=".Brushes">Brushes</li>
            ...
            <div class="row featured__filter">
                <?php
                $sql = "SELECT * FROM products WHERE p_isFeatured = TRUE";
