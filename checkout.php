                            ...
                            <div class="checkout__order">
                                ...
                                if (mysqli_num_rows($cart_items) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($cart_items)) {
                                        ...
                                        echo '
                                            <li>'.substr($row["p_name"],0, 22).'...<span>Rs.'.$total_item_value.'.00</span></li>
                                        ';
                                    }
                                } else {
                                    echo "0 results";
                                ...
                                <div class="checkout__order__subtotal">Subtotal <span>Rs.<?php echo $total_value;?>.00</span></div>
                                <div class="checkout__order__total">Total <span>Rs.<?php echo $total_value;?>.00</span></div>
