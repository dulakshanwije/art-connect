                        ...
                        <form action="" id="post_form" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="post_name" placeholder="Post Name" name="post_name">
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="post_body" rows="5" placeholder="Post Body" name="post_body"></textarea>
                            </div>
                            <div class="form-row">
                            ...
                            <p class="text-dark">
                               *Please refrain from uploading artwork created by other artists. We do not accept responsibility for unauthorized submissions on our website.
                            </p>
